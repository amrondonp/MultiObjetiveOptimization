...
public class MainWindow extends javax.swing.JFrame {
  private static final long serialVersionUID = 3847580784820687848L;
  ...
  private void initComponents() {
    ...
    btnApplyPromethee.addActionListener(
      new java.awt.event.ActionListener() {
    ...
    jLabel4.setText(
      "TOMA DE DECISIONES MULTICRITERIO EN CADENAS DE SUMINISTRO"
    );
  ...
  private void btnApplyPrometheeActionPerformed(
    java.awt.event.ActionEvent evt
  ) { //GEN-FIRST:event_btnApplyPrometheeActionPerformed
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java
        .util.logging.Logger.getLogger(MainWindow.class.getName())
